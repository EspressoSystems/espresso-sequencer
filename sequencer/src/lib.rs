...
type QuorumExchangeType<C> = QuorumExchange<
    ...
    MemoryCommChannel<SeqTypes, Node<C>, ProposalType, VoteType, MembershipType>,
...
impl<C> NodeImplementation<SeqTypes> for Node<C>
where
    C: Debug
        + Clone
...
//         CommitteeExchange = CommitteeExchange<
//             SeqTypes,
//             LeafType,
//             GeneralStaticCommittee<SeqTypes, LeafType, SignatureKeyType>,
//             C,
