...
use crate::{v0::BlockBuildingSnafu, Error, NameSpaceTable, NamespaceId, Table, TableWordTraits, TxTable, TxTableEntry};
...
#[cfg(test)]
pub(super) mod test {
    use crate::TableWordTraits;
    use crate::TxTableEntry;
