...
use espresso_types::{parse_duration, FeeAmount};
use ethers::prelude::*;
...
pub struct StakeTableUpdateOpts {
    ...
    pub initial_stake_table_path: PathBuf,
}
...
impl TestConfig {
    pub async fn new() -> Result<Self> {
        ...
        Ok(Self {
            load_generator_url,
            provider: Provider::<Http>::try_from(l1_provider_url.clone())?
