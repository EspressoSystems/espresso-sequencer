...
//     let mut f_bytes = vec![0u8; f.serialized_size(Compress::No)];
//     let res = f.serialize_uncompressed(&mut f_bytes);
//     assert!(res.is_ok());
//     f_bytes[32..].to_vec() // TODO why are the first 32 bits set to 0?
// }
#[allow(dead_code)]
