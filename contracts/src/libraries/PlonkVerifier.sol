...
import { LightClientStateUpdateVK as VKLib } from "./LightClientStateUpdateVK.sol";
...
library PlonkVerifier {
    ...
    function _computeChallenges(
        ...
        // TODO Philippe this is a hack, but otherwise many tests break. Let us discuss a clean way
        // to handle this hardcoded part of the transcript.
        if (verifyingKey.id == VKLib.LIGHTCLIENT_STATE_UPDATE_VK_ID) {
