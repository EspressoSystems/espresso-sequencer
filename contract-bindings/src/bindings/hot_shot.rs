...
pub mod hot_shot {
    ...
    impl<M: ::ethers::providers::Middleware> HotShot<M> {
        ...
        ///Calls the contract's `verify_agg_sig` (0xc152e568) function
    ...
    ///Container type for all input parameters for the `verify_agg_sig` function with signature `verify_agg_sig(bytes,(uint256,uint256),uint256[],uint256)` and selector `0xc152e568`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        name = "verify_agg_sig",
        abi = "verify_agg_sig(bytes,(uint256,uint256),uint256[],uint256)"
    )]
