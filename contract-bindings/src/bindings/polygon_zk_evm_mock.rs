...
pub mod polygon_zk_evm_mock {
    ...
    impl<M: ethers::providers::Middleware> PolygonZkEVMMock<M> {
        ...
        #[doc = "Calls the contract's `verifyBatchesTrustedAggregator` (0xd9794136) function"]
        pub fn verify_batches_trusted_aggregator(
            ...
            new_local_exit_root: [u8; 32],
            new_state_root: [u8; 32],
            old_acc_input_hash: [u8; 32],
            new_acc_input_hash: [u8; 32],
            proof_a: [ethers::core::types::U256; 2usize],
            proof_b: [[ethers::core::types::U256; 2usize]; 2usize],
            proof_c: [ethers::core::types::U256; 2usize],
            comm_proof: ethers::core::types::Bytes,
        ) -> ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash(
                    [217, 121, 65, 54],
    ...
    pub struct VerifyBatchesCall {
        ...
        pub proof_b: [[ethers::core::types::U256; 2usize]; 2usize],
        pub proof_c: [ethers::core::types::U256; 2usize],
        pub packed: HotShotParameters,
    }
    #[doc = "Container type for all input parameters for the `verifyBatchesTrustedAggregator` function with signature `verifyBatchesTrustedAggregator(uint64,uint64,uint64,bytes32,bytes32,bytes32,bytes32,uint256[2],uint256[2][2],uint256[2],bytes)` and selector `[217, 121, 65, 54]`"]
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    #[ethcall(
        name = "verifyBatchesTrustedAggregator",
        abi = "verifyBatchesTrustedAggregator(uint64,uint64,uint64,bytes32,bytes32,bytes32,bytes32,uint256[2],uint256[2][2],uint256[2],bytes)"
    )]
    ...
    impl ethers::core::abi::AbiDecode for PolygonZkEVMMockCalls {
        fn decode(
            ...
            {
                return Ok(PolygonZkEVMMockCalls::HotShot(decoded));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for PolygonZkEVMMockCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                PolygonZkEVMMockCalls::HotShot(element) => element.encode(),
    ...
    impl ::std::fmt::Display for PolygonZkEVMMockCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                PolygonZkEVMMockCalls::HotShot(element) => element.fmt(f),
    ...
    impl ::std::convert::From<HotShotCall> for PolygonZkEVMMockCalls {
        fn from(var: HotShotCall) -> Self {
            PolygonZkEVMMockCalls::HotShot(var)
        }
    }
