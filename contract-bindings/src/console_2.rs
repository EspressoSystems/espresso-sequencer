...
pub mod console_2 {
    ...
    pub static CONSOLE2_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static CONSOLE2_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M> ::core::fmt::Debug for console2<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(console2))
                .field(&self.address())
                .finish()
        }
    }
