pub use light_client_constructor_test::*;
...
pub mod light_client_constructor_test {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("test_CorrectInitialization"),
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("test_CorrectInitialization",),
                        inputs: ::std::vec![],
                        outputs: ::std::vec![],
                        constant: ::core::option::Option::None,
                        state_mutability: ::ethers::core::abi::ethabi::StateMutability::NonPayable,
                ...
                (
                    ::std::borrow::ToOwned::to_owned("test_RevertWhen_InvalidGenesis"),
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("test_RevertWhen_InvalidGenesis",),
                        inputs: ::std::vec![],
                        outputs: ::std::vec![],
                        constant: ::core::option::Option::None,
                        state_mutability: ::ethers::core::abi::ethabi::StateMutability::NonPayable,
    ...
    pub static LIGHTCLIENT_CONSTRUCTOR_TEST_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct LightClient_constructor_Test<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for LightClient_constructor_Test<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for LightClient_constructor_Test<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for LightClient_constructor_Test<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for LightClient_constructor_Test<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(LightClient_constructor_Test))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> LightClient_constructor_Test<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(::ethers::contract::Contract::new(
                address.into(),
                LIGHTCLIENT_CONSTRUCTOR_TEST_ABI.clone(),
                client,
            ))
        }
        ...
        ///Calls the contract's `test_CorrectInitialization` (0xabb719c8) function
        pub fn test_correct_initialization(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([171, 183, 25, 200], ())
                .expect("method not found (this should never happen)")
        }
        ///Calls the contract's `test_RevertWhen_InvalidGenesis` (0x7dfe37b3) function
        pub fn test_revert_when_invalid_genesis(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([125, 254, 55, 179], ())
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            LightClient_constructor_TestEvents,
        > {
            self.0
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
        for LightClient_constructor_Test<M>
    {
    ...
    pub enum LightClient_constructor_TestEvents {
        LogFilter(LogFilter),
    ...
    impl ::ethers::contract::EthLogDecode for LightClient_constructor_TestEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = LogFilter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogFilter(decoded));
            }
            if let Ok(decoded) = LogAddressFilter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogAddressFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = LogArray1Filter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogArray1Filter(decoded));
            }
            if let Ok(decoded) = LogArray2Filter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogArray2Filter(decoded));
            }
            if let Ok(decoded) = LogArray3Filter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogArray3Filter(decoded));
            }
            if let Ok(decoded) = LogBytesFilter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogBytesFilter(decoded));
            }
            if let Ok(decoded) = LogBytes32Filter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogBytes32Filter(
                    decoded,
                ));
            }
            if let Ok(decoded) = LogIntFilter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogIntFilter(decoded));
            }
            if let Ok(decoded) = LogNamedAddressFilter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogNamedAddressFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = LogNamedArray1Filter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogNamedArray1Filter(
                    decoded,
                ));
            }
            if let Ok(decoded) = LogNamedArray2Filter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogNamedArray2Filter(
                    decoded,
                ));
            }
            if let Ok(decoded) = LogNamedArray3Filter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogNamedArray3Filter(
                    decoded,
                ));
            }
            if let Ok(decoded) = LogNamedBytesFilter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogNamedBytesFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = LogNamedBytes32Filter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogNamedBytes32Filter(
                    decoded,
                ));
            }
            if let Ok(decoded) = LogNamedDecimalIntFilter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogNamedDecimalIntFilter(decoded));
            }
            if let Ok(decoded) = LogNamedDecimalUintFilter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogNamedDecimalUintFilter(decoded));
            }
            if let Ok(decoded) = LogNamedIntFilter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogNamedIntFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = LogNamedStringFilter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogNamedStringFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = LogNamedUintFilter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogNamedUintFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = LogStringFilter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogStringFilter(decoded));
            }
            if let Ok(decoded) = LogUintFilter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogUintFilter(decoded));
            }
            if let Ok(decoded) = LogsFilter::decode_log(log) {
                return Ok(LightClient_constructor_TestEvents::LogsFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for LightClient_constructor_TestEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<LogFilter> for LightClient_constructor_TestEvents {
        fn from(value: LogFilter) -> Self {
            Self::LogFilter(value)
        }
    }
    impl ::core::convert::From<LogAddressFilter> for LightClient_constructor_TestEvents {
        fn from(value: LogAddressFilter) -> Self {
            Self::LogAddressFilter(value)
        }
    }
    impl ::core::convert::From<LogArray1Filter> for LightClient_constructor_TestEvents {
        fn from(value: LogArray1Filter) -> Self {
            Self::LogArray1Filter(value)
        }
    }
    impl ::core::convert::From<LogArray2Filter> for LightClient_constructor_TestEvents {
        fn from(value: LogArray2Filter) -> Self {
            Self::LogArray2Filter(value)
        }
    }
    impl ::core::convert::From<LogArray3Filter> for LightClient_constructor_TestEvents {
        fn from(value: LogArray3Filter) -> Self {
            Self::LogArray3Filter(value)
        }
    }
    impl ::core::convert::From<LogBytesFilter> for LightClient_constructor_TestEvents {
        fn from(value: LogBytesFilter) -> Self {
            Self::LogBytesFilter(value)
        }
    }
    impl ::core::convert::From<LogBytes32Filter> for LightClient_constructor_TestEvents {
        fn from(value: LogBytes32Filter) -> Self {
            Self::LogBytes32Filter(value)
        }
    }
    impl ::core::convert::From<LogIntFilter> for LightClient_constructor_TestEvents {
        fn from(value: LogIntFilter) -> Self {
            Self::LogIntFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedAddressFilter> for LightClient_constructor_TestEvents {
        fn from(value: LogNamedAddressFilter) -> Self {
            Self::LogNamedAddressFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedArray1Filter> for LightClient_constructor_TestEvents {
        fn from(value: LogNamedArray1Filter) -> Self {
            Self::LogNamedArray1Filter(value)
        }
    }
    impl ::core::convert::From<LogNamedArray2Filter> for LightClient_constructor_TestEvents {
        fn from(value: LogNamedArray2Filter) -> Self {
            Self::LogNamedArray2Filter(value)
        }
    }
    impl ::core::convert::From<LogNamedArray3Filter> for LightClient_constructor_TestEvents {
        fn from(value: LogNamedArray3Filter) -> Self {
            Self::LogNamedArray3Filter(value)
        }
    }
    impl ::core::convert::From<LogNamedBytesFilter> for LightClient_constructor_TestEvents {
        fn from(value: LogNamedBytesFilter) -> Self {
            Self::LogNamedBytesFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedBytes32Filter> for LightClient_constructor_TestEvents {
        fn from(value: LogNamedBytes32Filter) -> Self {
            Self::LogNamedBytes32Filter(value)
        }
    }
    impl ::core::convert::From<LogNamedDecimalIntFilter> for LightClient_constructor_TestEvents {
        fn from(value: LogNamedDecimalIntFilter) -> Self {
            Self::LogNamedDecimalIntFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedDecimalUintFilter> for LightClient_constructor_TestEvents {
        fn from(value: LogNamedDecimalUintFilter) -> Self {
            Self::LogNamedDecimalUintFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedIntFilter> for LightClient_constructor_TestEvents {
        fn from(value: LogNamedIntFilter) -> Self {
            Self::LogNamedIntFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedStringFilter> for LightClient_constructor_TestEvents {
        fn from(value: LogNamedStringFilter) -> Self {
            Self::LogNamedStringFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedUintFilter> for LightClient_constructor_TestEvents {
        fn from(value: LogNamedUintFilter) -> Self {
            Self::LogNamedUintFilter(value)
        }
    }
    impl ::core::convert::From<LogStringFilter> for LightClient_constructor_TestEvents {
        fn from(value: LogStringFilter) -> Self {
            Self::LogStringFilter(value)
        }
    }
    impl ::core::convert::From<LogUintFilter> for LightClient_constructor_TestEvents {
        fn from(value: LogUintFilter) -> Self {
            Self::LogUintFilter(value)
        }
    }
    impl ::core::convert::From<LogsFilter> for LightClient_constructor_TestEvents {
    ...
    ///Container type for all input parameters for the `test_CorrectInitialization` function with signature `test_CorrectInitialization()` and selector `0xabb719c8`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        name = "test_CorrectInitialization",
        abi = "test_CorrectInitialization()"
    )]
    pub struct TestCorrectInitializationCall;
    ///Container type for all input parameters for the `test_RevertWhen_InvalidGenesis` function with signature `test_RevertWhen_InvalidGenesis()` and selector `0x7dfe37b3`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        name = "test_RevertWhen_InvalidGenesis",
        abi = "test_RevertWhen_InvalidGenesis()"
    )]
    pub struct TestRevertWhenInvalidGenesisCall;
    ...
    pub enum LightClient_constructor_TestCalls {
        ...
        TestCorrectInitialization(TestCorrectInitializationCall),
        TestRevertWhenInvalidGenesis(TestRevertWhenInvalidGenesisCall),
    }
    impl ::ethers::core::abi::AbiDecode for LightClient_constructor_TestCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded) =
                <TestCorrectInitializationCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::TestCorrectInitialization(decoded));
            }
            if let Ok(decoded) =
                <TestRevertWhenInvalidGenesisCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::TestRevertWhenInvalidGenesis(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ::ethers::core::abi::AbiEncode for LightClient_constructor_TestCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::TestCorrectInitialization(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::TestRevertWhenInvalidGenesis(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
            }
        }
    }
    impl ::core::fmt::Display for LightClient_constructor_TestCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::TestCorrectInitialization(element) => ::core::fmt::Display::fmt(element, f),
                Self::TestRevertWhenInvalidGenesis(element) => {
    ...
    impl ::core::convert::From<BlocksPerEpochTestCall> for LightClient_constructor_TestCalls {
        fn from(value: BlocksPerEpochTestCall) -> Self {
            Self::BlocksPerEpochTest(value)
        }
    }
    impl ::core::convert::From<IsTestCall> for LightClient_constructor_TestCalls {
        fn from(value: IsTestCall) -> Self {
            Self::IsTest(value)
        }
    }
    impl ::core::convert::From<AssertEqCall> for LightClient_constructor_TestCalls {
        fn from(value: AssertEqCall) -> Self {
            Self::AssertEq(value)
        }
    }
    impl ::core::convert::From<ExcludeArtifactsCall> for LightClient_constructor_TestCalls {
        fn from(value: ExcludeArtifactsCall) -> Self {
            Self::ExcludeArtifacts(value)
        }
    }
    impl ::core::convert::From<ExcludeContractsCall> for LightClient_constructor_TestCalls {
        fn from(value: ExcludeContractsCall) -> Self {
            Self::ExcludeContracts(value)
        }
    }
    impl ::core::convert::From<ExcludeSendersCall> for LightClient_constructor_TestCalls {
        fn from(value: ExcludeSendersCall) -> Self {
            Self::ExcludeSenders(value)
        }
    }
    impl ::core::convert::From<FailedCall> for LightClient_constructor_TestCalls {
        fn from(value: FailedCall) -> Self {
            Self::Failed(value)
        }
    }
    impl ::core::convert::From<GenesisCall> for LightClient_constructor_TestCalls {
        fn from(value: GenesisCall) -> Self {
            Self::Genesis(value)
        }
    }
    impl ::core::convert::From<GetFinalizedStateCall> for LightClient_constructor_TestCalls {
        fn from(value: GetFinalizedStateCall) -> Self {
            Self::GetFinalizedState(value)
        }
    }
    impl ::core::convert::From<GetGenesisStateCall> for LightClient_constructor_TestCalls {
        fn from(value: GetGenesisStateCall) -> Self {
            Self::GetGenesisState(value)
        }
    }
    impl ::core::convert::From<InitCall> for LightClient_constructor_TestCalls {
        fn from(value: InitCall) -> Self {
            Self::Init(value)
        }
    }
    impl ::core::convert::From<SetUpCall> for LightClient_constructor_TestCalls {
        fn from(value: SetUpCall) -> Self {
            Self::SetUp(value)
        }
    }
    impl ::core::convert::From<TargetArtifactSelectorsCall> for LightClient_constructor_TestCalls {
        fn from(value: TargetArtifactSelectorsCall) -> Self {
            Self::TargetArtifactSelectors(value)
        }
    }
    impl ::core::convert::From<TargetArtifactsCall> for LightClient_constructor_TestCalls {
        fn from(value: TargetArtifactsCall) -> Self {
            Self::TargetArtifacts(value)
        }
    }
    impl ::core::convert::From<TargetContractsCall> for LightClient_constructor_TestCalls {
        fn from(value: TargetContractsCall) -> Self {
            Self::TargetContracts(value)
        }
    }
    impl ::core::convert::From<TargetSelectorsCall> for LightClient_constructor_TestCalls {
        fn from(value: TargetSelectorsCall) -> Self {
            Self::TargetSelectors(value)
        }
    }
    impl ::core::convert::From<TargetSendersCall> for LightClient_constructor_TestCalls {
        fn from(value: TargetSendersCall) -> Self {
            Self::TargetSenders(value)
        }
    }
    impl ::core::convert::From<TestCorrectInitializationCall> for LightClient_constructor_TestCalls {
        fn from(value: TestCorrectInitializationCall) -> Self {
            Self::TestCorrectInitialization(value)
        }
    }
    impl ::core::convert::From<TestRevertWhenInvalidGenesisCall> for LightClient_constructor_TestCalls {
        fn from(value: TestRevertWhenInvalidGenesisCall) -> Self {
            Self::TestRevertWhenInvalidGenesis(value)
        }
    }
