...
pub mod hot_shot {
    ...
    pub static HOTSHOT_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl<M> ::core::fmt::Debug for HotShot<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(HotShot)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> HotShot<M> {
        ...
        pub fn get_staking_key(
            ...
            M,
            (G2Point, ::ethers::core::types::U256),
        > {
            self.0
    ...
    impl ::ethers::core::abi::AbiDecode for HotShotErrors {
        fn decode(
            ...
            if let Ok(decoded)
                = <BLSSigVerificationFailed as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::BLSSigVerificationFailed(decoded));
            }
            if let Ok(decoded)
                = <IncorrectBlockNumber as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::IncorrectBlockNumber(decoded));
            }
            if let Ok(decoded)
                = <InvalidQC as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::InvalidQC(decoded));
            }
            if let Ok(decoded)
                = <NoKeySelected as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::NoKeySelected(decoded));
            }
            if let Ok(decoded)
                = <NotEnoughStake as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::NotEnoughStake(decoded));
            }
            if let Ok(decoded)
                = <TooManyBlocks as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for HotShotErrors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                ...
                Self::InvalidQC(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::NoKeySelected(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::NotEnoughStake(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::TooManyBlocks(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::ethers::contract::ContractRevert for HotShotErrors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector
                    == <InvalidQC as ::ethers::contract::EthError>::selector() => true,
                _ if selector
                    == <NoKeySelected as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ if selector
                    == <NotEnoughStake as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ if selector
                    == <TooManyBlocks as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ => false,
            }
    ...
    impl ::core::fmt::Display for HotShotEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::NewStakingKeyFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
            }
        }
    ...
    impl ::ethers::core::abi::AbiDecode for HotShotCalls {
        fn decode(
            ...
            let data = data.as_ref();
            if let Ok(decoded)
                = <MaxBlocksCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::MaxBlocks(decoded));
            }
            if let Ok(decoded)
                = <AddNewStakingKeyCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::AddNewStakingKey(decoded));
            }
            if let Ok(decoded)
                = <BlockHeightCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <GetStakingKeyCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::GetStakingKey(decoded));
            }
            if let Ok(decoded)
                = <NewBlocksCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::NewBlocks(decoded));
            }
            if let Ok(decoded)
                = <VerifyAggSigCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for HotShotCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                Self::MaxBlocks(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::AddNewStakingKey(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::BlockHeight(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::Commitments(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::GetStakingKey(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::NewBlocks(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::VerifyAggSig(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
            }
        }
