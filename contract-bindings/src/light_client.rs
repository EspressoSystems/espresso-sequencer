...
pub mod light_client {
    ...
    impl ::core::convert::From<InvalidHotShotBlockForCheckingBlockCommitments> for LightClientErrors {
    ...
    impl ::core::convert::From<InvalidL1BlockForCheckingL1Updates> for LightClientErrors {
    ...
    impl ::core::convert::From<GetL1BlockUpdatesCountCall> for LightClientCalls {
    ...
    impl ::core::convert::From<L1BlockUpdatesCall> for LightClientCalls {
