...
pub mod ierc721_metadata {
    ...
    impl<M: ::ethers::providers::Middleware> IERC721Metadata<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IERC721MetadataEvents>
        {
            self.0
    ...
    impl ::core::convert::From<SafeTransferFromWithFromAndToAndDataCall> for IERC721MetadataCalls {
